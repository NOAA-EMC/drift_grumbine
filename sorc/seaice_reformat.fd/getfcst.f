...
C     Updated for F90 and better behavior as sbr -- assume file is open,
C       Robert Grumbine 28 May 2014
...
C     The 1 shift is because 1 is added to fday, count before the attempt to read
      code = fday - 1
      npts = count - 1
!      DO i = 1, npts
